...
y_b= float(input("Введите координату х т.В:"))
x_c= float(input("Введите координату х т.С:"))
y_c= float(input("Введите координату х т.С:"))
c = float(sqrt(((x_b-x_a)**2+(y_b-y_a)**2)))
print(c)
a = float(sqrt(((x_c-x_b)**2+(y_c-y_b)**2)))
print(c)
b = float(sqrt(((x_c-x_a)**2+(y_c-y_a)**2)))
print(b)
ab=a+b
ac=a+c
cb=c+b
